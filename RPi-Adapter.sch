...
<variantdefs>
<variantdef name="RPi-Adapter"/>
<variantdef name="Slave-Board"/>
</variantdefs>
<classes>
...
<parts>
<part name="FRAME1" library="frames" deviceset="DINA4_L" device="" value="RaspberryPi 3 Interface"/>
<part name="SV1" library="con-lsta" deviceset="FE20-2" device="">
<variant name="Slave-Board" populate="no"/>
</part>
<part name="PCB1" library="e14_Rpi3_RevA" deviceset="RPI3_EXT" device=""/>
<part name="FRAME2" library="frames" deviceset="A5L-LOC" device="" value="GPIO-Extender"/>
<part name="IC1" library="microchip" deviceset="MCP23017" device="SP"/>
<part name="FRAME3" library="frames" deviceset="A5L-LOC" device="" value="Expansion-Headers"/>
...
<part name="FRAME5" library="frames" deviceset="DINA5_L" device="" value="RJ45"/>
...
<part name="IC2" library="lm1117_11" deviceset="LM1117?-*" device="MP" technology="3.3" value="LM1117MP-3.3"/>
<part name="X1" library="con-ptr500" deviceset="AK500/2" device="" value="Power">
<variant name="Slave-Board" populate="no"/>
</part>
...
<sheets>
<sheet>
<description>&lt;h1&gt;RaspberryPi 3 Interface&lt;/h1&gt;

&lt;h2&gt;Hardware&lt;/h2&gt;
&lt;h3&gt;Prozessor&lt;/h3&gt;
Der RaspberryPi3 ist ein Ein-Platinen-Computer auf der Grundlage der ARM-Prozessorarchitektur. welche durch die Firma Broadcom lizensiert und im SoC &lt;a href="https://www.raspberrypi.org/wp-content/uploads/2012/02/BCM2835-ARM-Peripherals.pdf"&gt;BCM2837&lt;/a&gt; implementiert wurde. Es handelt sich dabei um eine &lt;b&gt;Quad-Core-SMP&lt;/b&gt;-Architektur mit einem Basistakt von &lt;b&gt;1.2Ghz&lt;/b&gt; und einer Adressbreite von &lt;b&gt;64-Bit&lt;/b&gt;.
&lt;h3&gt;GPU&lt;/h3&gt;
Der BCM2835-Prozessor ist als System-On-Chip konzipiert und stellt einen Grafikprozessor auf der Grundlage der &lt;a href="http://elinux.org/Raspberry_Pi_VideoCore_APIs"0&gt;Broadcom-VideoCore IV&lt;/a&gt; IP bereit. Diese ist in der Lage, Full-HD-Videos abzuspielen und stellt auch OpenGL ES 2.0 bzw. OpenVG für Anwendungen bereit.
&lt;h3&gt;Speicher&lt;/h3&gt;
Wie für fast jegliche Art von Computersystem ist auch für den RaspberryPi3 eine &lt;b&gt;Speicherhierarchie&lt;/b&gt; definiert.
Der schnelle, aber flüchtige Arbeitsspeicher &lt;b&gt;(RAM)&lt;/b&gt; des RaspberryPi ist mit 900Mhz getaktet (LPDDR2) und steht in einer Kapazität von &lt;b&gt;1GB&lt;/b&gt; bereit. Das langsame, aber persistente Halten von Daten wird durch eine externe SD-Karte realisiert.
&lt;h3&gt;Netzwerk&lt;/h3&gt;
Ein wesentlicher Unterschied neben der erhöhten Performance gegenüber dem RaspberryPi2 ist eine neu hinzugekommene Wireless-Funktionalität. So ist der RPi3 bereits im Auslieferungszustand in der Lage, &lt;b&gt;Bluetooth-LowEnergy&lt;/b&gt; und WLAN-Verbindungen (&lt;b&gt;IEEE802.11n&lt;/b&gt;) herzustellen. Diese Funktionalität wird über den Chipsatz &lt;a href="http://www.cypress.com/file/298756/download"&gt;BCM43143&lt;/a&gt; realisiert. Zusätzlich steht wie in den Vorgängermodellen des RPi eine RJ45-Schnittstelle bereit, über die 100MBit-Ethernetverbindungen hergestellt werden können.
&lt;h3&gt;Peripherie&lt;/h3&gt;
Zusätzliche Komponenten des RaspberryPi3 sind die erweiterte Anzahl von USB-Schnittstellen (&lt;b&gt;4x USB 2.0&lt;/b&gt; gegenüber den 2xUSB1.1 vom ursprünglichen Board aus dem Jahre 2012), welche über das Bauteil &lt;a href="http://ww1.microchip.com/downloads/en/DeviceDoc/9514.pdf"&gt;SMSC LAN 9514&lt;/a&gt; realisiert wird (dieses implementiert gleichzeitig auch den Ethernet-Stack).
&lt;p&gt;
Daneben ist für den RPi3 auch eine &lt;b&gt;CSI-Kameraschnittstelle&lt;/b&gt; für serielle Datenübertragung von HD-Kameramodulen vorgesehen, mit der entsprechende Kameramodule hochauflösend an den BCM-Prozessor angebunden werden können.
&lt;p&gt;
Zur Darstellung der Benutzeroberfläche dient eine &lt;b&gt;HDMI-&lt;/b&gt; und eine &lt;b&gt;DSI-Displayschnittstelle&lt;/b&gt;, über die mittels Differenzsignalen hochfrequent und störungsfrei Daten zu Displays übertragen werden können (&lt;b&gt;LVDS&lt;/b&gt;). Dies entspricht im Wesentlichen dem Verhalten der HDMI-Schnittstelle, welche zum Anschluss externer Monitore bereitsteht und deren LVDS-Signale durch die oben genannte VideoCore-GPU generiert werden.
&lt;p&gt;
...
&lt;h3&gt;Erweiterungen&lt;/h3&gt;
Für das hier dokumentierte Projekt ist allerdings eine andere Eigenschaft des RaspberryPi entscheidend: der RaspberryPi 3 besitzt nämlich eine 40-polige Steckerleiste zur Anbindung externer Peripherie. Darüber können universell benutzbare Ein-/Ausgabe-Pins (&lt;b&gt;GPIO=General Purpose I/O&lt;/b&gt;) mit LVTTL Pegeln (&lt;b&gt;3.3V&lt;/b&gt;) geschaltet bzw. hochohmig gelesen werden. Manche dieser GPIO Pins besitzen eine Doppelbelegung, die bei Konfiguration der richtigen Register des BroadCom-SoCs die Zweitfunktionalität freischaltet. Dies betrifft z.B. Platinenbusse wie &lt;b&gt;SPI&lt;/b&gt; oder &lt;b&gt;I²C&lt;/b&gt;, die Ansteuerung von RS232-/ oder RS485-Treibern (&lt;b&gt;UART&lt;/b&gt;), aber auch die Generierung von externen Signalformen mittels Hardware-unterstützter Pulsweitenmodulation (&lt;b&gt;PWM&lt;/b&gt;). Maximal belastbar sind die GPIO-Ausgabekanäle mit &lt;b&gt;50mA&lt;/b&gt;, was zum direkten Schalten von LEDs ausreicht, für größere Lasten aber Bipolar- bzw. Feldeffekttransistoren benötigt. 

&lt;h2&gt;Betriebssystem&lt;/h2&gt;
Der RaspberryPi kann mit verschiedenen Betriebssystemen betrieben werden. Unter anderem stehen verschiedene Linux-Distributionen wie &lt;a href="Raspbian"&gt;Raspbian&lt;/a&gt; oder das für MediaCenter optimierte &lt;a href="http://www.openelec.tv"&gt;OpenELEC&lt;/a&gt; zur Verfügung. Auch eine Verwendung mit Microsoft-Plattformen ist möglich, so kann etwa auch &lt;a href="https://developer.microsoft.com/de-de/windows/iot"&gt;Windows10-IoT&lt;/a&gt; für den RaspberryPi3 verwendet werden.

&lt;h3&gt;Programmierung&lt;/h3&gt;
Zur Programmierung eigener Anwendungen ist für Linux-Betriebssysteme die Programmiersprache &lt;a href="http://www.python.org"&gt;Python&lt;/a&gt; das Mittel der Wahl. Sie stellt eine sehr einfache und für Einsteiger leicht zu erlernende Syntax bereit und kann durch &lt;a href="https://riverbankcomputing.com/software/pyqt/intro"&gt;PyQT&lt;/a&gt; leicht grafische Anwendungen erzeugen. Zur Ansteuerung der GPIOs kann die Softwarekomponente &lt;a href="http://raspberrypiguide.de/howtos/raspberry-pi-gpio-how-to/"&gt;WiringPi&lt;/a&gt; genutzt werden. Neben Python stehen auch Compiler für Programmiersprachen wie C/C++, Java oder &lt;a href="http://www.adacore.com/press/adacore-introduces-gnat-gpl-2015-for-the-raspberry-pi-2/"&gt;ADA&lt;/a&gt; bereit.
&lt;p&gt;
Für die Verwendung von Windows 10 IoT muss statt dessen das &lt;a href="https://developer.microsoft.com/en-us/windows/iot/docs/setuppcrpi"&gt;VisualStudio 2015&lt;/a&gt; verwendet werden. Damit wird eine Programmierung mit C# und dem .NET Framework möglich.</description>
<plain>
</plain>
<instances>
<instance part="FRAME1" gate="G$1" x="0" y="0"/>
<instance part="FRAME1" gate="G$2" x="162.56" y="0"/>
<instance part="SV1" gate="G$1" x="38.1" y="78.74" rot="MR180"/>
<instance part="PCB1" gate="G$1" x="76.2" y="48.26"/>
</instances>
<busses>
<bus name="+5V,+3.3V,GND,ID_SD,ID_SC,I2C_SDA,I2C_SCL,GPIO4,GPIO5,GPIO6,SPI_CE1_N,SPI_CE0_N,SPI_MISO,SPI_MOSI,SPI_CLK,GPIO12,GPIO13,TXD,RXD,GPIO16,GPIO17,PWM,GPIO19,GPIO20,GPIO21,GPIO22,GPIO23,GPIO24,GPIO25,GPIO26,GPIO27">
<segment>
<wire x1="177.8" y1="134.62" x2="33.02" y2="134.62" width="0.762" layer="92"/>
<wire x1="33.02" y1="134.62" x2="25.4" y2="127" width="0.762" layer="92"/>
<wire x1="25.4" y1="127" x2="25.4" y2="50.8" width="0.762" layer="92"/>
<wire x1="25.4" y1="50.8" x2="30.48" y2="45.72" width="0.762" layer="92"/>
<wire x1="30.48" y1="45.72" x2="45.72" y2="45.72" width="0.762" layer="92"/>
<wire x1="45.72" y1="45.72" x2="50.8" y2="50.8" width="0.762" layer="92"/>
<wire x1="50.8" y1="50.8" x2="50.8" y2="109.22" width="0.762" layer="92"/>
</segment>
</bus>
</busses>
<nets>
...
<segment>
<wire x1="83.82" y1="134.62" x2="88.9" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="50.8" y1="99.06" x2="48.26" y2="101.6" width="0.1524" layer="91"/>
...
<segment>
<wire x1="78.74" y1="134.62" x2="81.28" y2="132.08" width="0.1524" layer="91"/>
...
<segment>
<wire x1="119.38" y1="134.62" x2="124.46" y2="129.54" width="0.1524" layer="91"/>
...
<label x="22.86" y="106.68" size="1.778" layer="95" rot="R180"/>
<pinref part="SV1" gate="G$1" pin="1"/>
</segment>
<segment>
<wire x1="25.4" y1="86.36" x2="27.94" y2="83.82" width="0.1524" layer="91"/>
...
<segment>
<wire x1="83.82" y1="134.62" x2="88.9" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="88.9" y1="134.62" x2="93.98" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="99.06" y1="134.62" x2="104.14" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="109.22" y1="134.62" x2="114.3" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="124.46" y1="134.62" x2="129.54" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="139.7" y1="134.62" x2="144.78" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="149.86" y1="134.62" x2="154.94" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="160.02" y1="134.62" x2="165.1" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="175.26" y1="134.62" x2="180.34" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="76.2" x2="27.94" y2="73.66" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="58.42" x2="27.94" y2="55.88" width="0.1524" layer="91"/>
...
<segment>
<wire x1="50.8" y1="96.52" x2="48.26" y2="99.06" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="101.6" x2="27.94" y2="99.06" width="0.1524" layer="91"/>
...
<segment>
<wire x1="93.98" y1="134.62" x2="99.06" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="99.06" x2="27.94" y2="96.52" width="0.1524" layer="91"/>
<wire x1="27.94" y1="96.52" x2="30.48" y2="96.52" width="0.1524" layer="91"/>
<label x="22.86" y="99.06" size="1.778" layer="95" rot="R180"/>
<pinref part="SV1" gate="G$1" pin="7"/>
</segment>
</net>
<net name="TXD" class="0">
<segment>
<wire x1="93.98" y1="134.62" x2="99.06" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="50.8" y1="93.98" x2="48.26" y2="96.52" width="0.1524" layer="91"/>
...
<segment>
<wire x1="99.06" y1="134.62" x2="104.14" y2="139.7" width="0.1524" layer="91"/>
...
<wire x1="104.14" y1="134.62" x2="109.22" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="93.98" x2="27.94" y2="91.44" width="0.1524" layer="91"/>
...
<segment>
<wire x1="104.14" y1="134.62" x2="109.22" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="50.8" y1="88.9" x2="48.26" y2="91.44" width="0.1524" layer="91"/>
...
<segment>
<wire x1="109.22" y1="134.62" x2="114.3" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="114.3" y1="134.62" x2="119.38" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="114.3" y1="134.62" x2="119.38" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="88.9" x2="27.94" y2="86.36" width="0.1524" layer="91"/>
...
<segment>
<wire x1="119.38" y1="134.62" x2="124.46" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="124.46" y1="134.62" x2="129.54" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="129.54" y1="134.62" x2="134.62" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="81.28" x2="27.94" y2="78.74" width="0.1524" layer="91"/>
...
<segment>
<wire x1="134.62" y1="134.62" x2="139.7" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="78.74" x2="27.94" y2="76.2" width="0.1524" layer="91"/>
...
<segment>
<wire x1="139.7" y1="134.62" x2="144.78" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="144.78" y1="134.62" x2="149.86" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="144.78" y1="134.62" x2="149.86" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="149.86" y1="134.62" x2="154.94" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="154.94" y1="134.62" x2="160.02" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="154.94" y1="134.62" x2="160.02" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="160.02" y1="134.62" x2="165.1" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="25.4" y1="66.04" x2="27.94" y2="63.5" width="0.1524" layer="91"/>
...
<segment>
<wire x1="165.1" y1="134.62" x2="170.18" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="165.1" y1="134.62" x2="170.18" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="170.18" y1="134.62" x2="175.26" y2="139.7" width="0.1524" layer="91"/>
...
<segment>
<wire x1="170.18" y1="134.62" x2="175.26" y2="129.54" width="0.1524" layer="91"/>
...
<segment>
<wire x1="175.26" y1="134.62" x2="180.34" y2="139.7" width="0.1524" layer="91"/>
...
<sheet>
<description>&lt;h1&gt;GPIO-Extender&lt;/h1&gt;
Hauptkomponente des Projekts ist der integrierte Schaltkreis &lt;a href="http://cdn-reichelt.de/documents/datenblatt/A200/DS_MCP23017.pdf"&gt;MCP23017&lt;/a&gt;, der als GPIO-Extender fungiert und über den I²C-Bus vom RaspberryPi aus gesteuert werden kann.
&lt;p&gt;
Die wesentliche Aufgabe des Bausteins ist die Behebung der Limitierung von I/O-Ports. Der RaspberryPi kann als I²C-Master theoretisch bis zu 127 Slaves adressieren, die Einschränkung soll hier bei maximal 8 Teilnehmern liegen.&lt;p&gt;
Der MCP23017 unterstützt zwei Kanäle mit je einer Breite von 8-Bit. Durch Konfiguration eines Datenrichtungsregisters können deren Pins zwischen Input- und Output umgeschaltet werden.</description>
<plain>
</plain>
<instances>
...
<bus name="BTN[0..7]">
<segment>
<wire x1="109.22" y1="76.2" x2="109.22" y2="99.06" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="LED[0..7]">
<segment>
<wire x1="109.22" y1="73.66" x2="109.22" y2="48.26" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="+5V,+3.3V,GND,ID_SD,ID_SC,I2C_SDA,I2C_SCL,GPIO4,GPIO5,GPIO6,GPIO7,GPIO8,GPIO9,GPIO10,GPIO11,GPIO12,GPIO13,GPIO14,GPIO15,GPIO16,GPIO17,PWM,GPIO19,GPIO20,GPIO21,GPIO22,GPIO23,GPIO24,GPIO25,GPIO26,GPIO27">
<segment>
<wire x1="40.64" y1="99.06" x2="40.64" y2="48.26" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="A[0..2]">
<segment>
<wire x1="66.04" y1="63.5" x2="66.04" y2="58.42" width="0.762" layer="92"/>
...
<sheet>
<description>&lt;h1&gt;Expansion-Header&lt;/h1&gt;
Die Expansion-Header entsprechen Stiftleisten zur Erweiterung der Funktionalität. So können für ein bestimmte Einsatzzweck erstellte Lochraster- bzw. Platinenaufbauten mit dem Board verwendet werden, solange sie den gleichen Footprint verwenden und die elektrischen Gegebenheiten passend antizipieren.</description>
<plain>
<text x="38.1" y="76.2" size="1.778" layer="91" rot="R180">EXT-GPIO-PORTA</text>
<text x="147.32" y="76.2" size="1.778" layer="91" rot="MR180">EXT-GPIO-PORTB</text>
<text x="30.48" y="104.14" size="1.778" layer="91">I²C</text>
<text x="63.5" y="104.14" size="1.778" layer="91">SPI</text>
<text x="104.14" y="104.14" size="1.778" layer="91">UART</text>
<text x="33.02" y="38.1" size="1.778" layer="91" rot="R180">EXT-POWER</text>
<text x="134.62" y="104.14" size="1.778" layer="91">PWM</text>
</plain>
<instances>
<instance part="FRAME3" gate="G$1" x="0" y="0"/>
<instance part="JP3" gate="G$1" x="43.18" y="119.38" rot="R90"/>
<instance part="JP4" gate="A" x="81.28" y="119.38" rot="R90"/>
<instance part="JP5" gate="A" x="116.84" y="119.38" rot="R90"/>
<instance part="JP1" gate="A" x="40.64" y="66.04" rot="R180"/>
<instance part="JP2" gate="A" x="144.78" y="66.04" rot="MR180"/>
<instance part="JP6" gate="A" x="43.18" y="38.1" rot="R90"/>
<instance part="JP7" gate="G$1" x="147.32" y="119.38" rot="R90"/>
</instances>
<busses>
<bus name="BTN[0..7]">
<segment>
<wire x1="71.12" y1="43.18" x2="71.12" y2="68.58" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="+12V,+5V,+3.3V,GND">
<segment>
<wire x1="35.56" y1="22.86" x2="48.26" y2="22.86" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="LED[0..7]">
<segment>
<wire x1="114.3" y1="68.58" x2="114.3" y2="43.18" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="I2C_SDA,I2C_SCL">
<segment>
<wire x1="35.56" y1="104.14" x2="48.26" y2="104.14" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="SPI_CE1_N,SPI_CE0_N,SPI_MISO,SPI_MOSI,SPI_CLK">
<segment>
<wire x1="68.58" y1="104.14" x2="93.98" y2="104.14" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="TXD,RXD,GND">
<segment>
<wire x1="111.76" y1="104.14" x2="124.46" y2="104.14" width="0.762" layer="92"/>
</segment>
</bus>
<bus name="PWM,GND">
<segment>
<wire x1="142.24" y1="104.14" x2="152.4" y2="104.14" width="0.762" layer="92"/>
</segment>
</bus>
</busses>
<nets>
...
<label x="116.84" y="101.6" size="1.778" layer="95" rot="R270"/>
</segment>
<segment>
...
<label x="147.32" y="101.6" size="1.778" layer="95" rot="R270"/>
</segment>
</net>
<net name="BTN0" class="0">
<segment>
<wire x1="71.12" y1="45.72" x2="68.58" y2="45.72" width="0.1524" layer="91"/>
<wire x1="68.58" y1="45.72" x2="58.42" y2="55.88" width="0.1524" layer="91"/>
<wire x1="58.42" y1="55.88" x2="43.18" y2="55.88" width="0.1524" layer="91"/>
<label x="78.74" y="45.72" size="1.778" layer="95" rot="R180"/>
...
<wire x1="68.58" y1="48.26" x2="58.42" y2="58.42" width="0.1524" layer="91"/>
...
<wire x1="68.58" y1="50.8" x2="58.42" y2="60.96" width="0.1524" layer="91"/>
...
<wire x1="68.58" y1="55.88" x2="58.42" y2="66.04" width="0.1524" layer="91"/>
...
<wire x1="68.58" y1="58.42" x2="58.42" y2="68.58" width="0.1524" layer="91"/>
...
<wire x1="68.58" y1="60.96" x2="58.42" y2="71.12" width="0.1524" layer="91"/>
...
<wire x1="68.58" y1="63.5" x2="58.42" y2="73.66" width="0.1524" layer="91"/>
...
<wire x1="68.58" y1="53.34" x2="58.42" y2="63.5" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="45.72" x2="127" y2="55.88" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="48.26" x2="127" y2="58.42" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="50.8" x2="127" y2="60.96" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="53.34" x2="127" y2="63.5" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="55.88" x2="127" y2="66.04" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="58.42" x2="127" y2="68.58" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="60.96" x2="127" y2="71.12" width="0.1524" layer="91"/>
...
<wire x1="116.84" y1="63.5" x2="127" y2="73.66" width="0.1524" layer="91"/>
<wire x1="127" y1="73.66" x2="142.24" y2="73.66" width="0.1524" layer="91"/>
<label x="111.76" y="63.5" size="1.778" layer="95" rot="R180"/>
...
<wire x1="114.3" y1="104.14" x2="114.3" y2="116.84" width="0.1524" layer="91"/>
<label x="114.3" y="101.6" size="1.778" layer="95" rot="R270"/>
</segment>
</net>
<net name="RXD" class="0">
<segment>
...
<label x="144.78" y="101.6" size="1.778" layer="95" rot="R270"/>
</segment>
</net>
</nets>
</sheet>
<sheet>
<description>&lt;h1&gt;RJ-45-Steckverbinder&lt;/h1&gt;
Zur Verbindung von Busteilnehmern kommen RJ-45-Steckverbinder zum Einsatz, die in der Netzwerktechnik weit verbreitet sind und daher leicht verfügbar bzw. erweiterbar sind. Das betrifft hauptsächlich die einfache und wartungsfreie Montage von Slave-Modulen im Gesamtsystem des Messeaufbaus.&lt;p&gt;
&lt;b&gt;Keine Kompatibilität zu Ethernet-Switches/-Hubs!&lt;/b&gt;
&lt;p&gt;
Die Belegung  der RJ-45-Buchse ist &lt;b&gt;proprietär und inkompatibel zu Ethernet&lt;/b&gt;. Konkret leisten muss die RJ45-Buchse:
&lt;ol&gt;
&lt;li&gt;Masseverbindung&lt;/li&gt;
&lt;li&gt;Reserviert&lt;/li&gt;
&lt;li&gt;I²C-Clock (+3.3V LVTTL)&lt;/li&gt;
&lt;li&gt;I²C-Data (+3.3V LVTTL)&lt;/li&gt;
&lt;li&gt;+12V DC-Versorgungsspannung&lt;/li&gt;
&lt;li&gt;Reset (Low-Active, +3.3V LVTTL)&lt;/li&gt;
&lt;li&gt;Reserviert&lt;/li&gt;
&lt;li&gt;Reserviert&lt;/li&gt;
&lt;/ol&gt;

Somit wird sichergestellt, dass selbst bei Verklemmung des I²C-Busses, ein durch den I²C-Master gesteuertes Reset ausgelöst werden kann. Die restlichen Aufgaben sind Datentransport und Bereitstellung einer gemeinsamen Spannungsquelle für alle Slaves.
&lt;p&gt;
Die handelsüblichen Cat5-Kabel bieten für dieses kleine I²C-Bussystem auch den Vorteil einer recht hohen Abschirmung gegenüber HF-Einströmungen, da die Adern paarweise geschirmt sind (Twisted-Pair). Damit sollte eine für PWM ausreichend hohe Taktung des I²C-Busses auch über mal 2-3m hin gewährleistet sein.</description>
<plain>
</plain>
<instances>
<instance part="FRAME5" gate="G$1" x="0" y="0"/>
<instance part="P+4" gate="1" x="38.1" y="78.74" rot="R90"/>
<instance part="GND4" gate="1" x="38.1" y="71.12" rot="R270"/>
<instance part="X2" gate="-" x="93.98" y="86.36" rot="R90"/>
<instance part="X2" gate="SHIELD@1" x="102.87" y="86.106" rot="R90"/>
<instance part="X2" gate="SHIELD@2" x="102.87" y="89.662" rot="R90"/>
<instance part="X2" gate="SHIELD@3" x="102.87" y="92.964" rot="R90"/>
<instance part="X3" gate="-" x="134.62" y="86.36" rot="R90"/>
<instance part="X3" gate="SHIELD@1" x="143.51" y="86.106" rot="R90"/>
<instance part="X3" gate="SHIELD@2" x="143.51" y="89.662" rot="R90"/>
<instance part="X3" gate="SHIELD@3" x="143.51" y="92.964" rot="R90"/>
<instance part="X3" gate="SHIELD@4" x="143.51" y="96.52" rot="R90"/>
<instance part="GND5" gate="1" x="111.76" y="91.44" rot="R90"/>
<instance part="GND6" gate="1" x="152.4" y="91.44" rot="R90"/>
</instances>
<busses>
</busses>
<nets>
<net name="GND" class="0">
<segment>
<pinref part="X2" gate="SHIELD@1" pin="1"/>
<pinref part="GND5" gate="1" pin="GND"/>
<wire x1="105.41" y1="86.106" x2="105.41" y2="89.662" width="0.1524" layer="91"/>
<wire x1="105.41" y1="89.662" x2="105.41" y2="91.44" width="0.1524" layer="91"/>
<wire x1="105.41" y1="91.44" x2="109.22" y2="91.44" width="0.1524" layer="91"/>
<wire x1="105.41" y1="96.52" x2="105.41" y2="92.964" width="0.1524" layer="91"/>
<pinref part="X2" gate="SHIELD@2" pin="1"/>
<junction x="105.41" y="89.662"/>
<pinref part="X2" gate="SHIELD@3" pin="1"/>
<junction x="105.41" y="92.964"/>
<wire x1="105.41" y1="92.964" x2="105.41" y2="91.44" width="0.1524" layer="91"/>
<junction x="105.41" y="91.44"/>
</segment>
<segment>
<pinref part="X3" gate="SHIELD@1" pin="1"/>
<pinref part="GND6" gate="1" pin="GND"/>
<wire x1="146.05" y1="86.106" x2="146.05" y2="89.662" width="0.1524" layer="91"/>
<wire x1="146.05" y1="89.662" x2="146.05" y2="91.44" width="0.1524" layer="91"/>
<wire x1="146.05" y1="91.44" x2="149.86" y2="91.44" width="0.1524" layer="91"/>
<pinref part="X3" gate="SHIELD@4" pin="1"/>
<wire x1="146.05" y1="96.52" x2="146.05" y2="92.964" width="0.1524" layer="91"/>
<pinref part="X3" gate="SHIELD@2" pin="1"/>
<junction x="146.05" y="89.662"/>
<junction x="146.05" y="91.44"/>
<pinref part="X3" gate="SHIELD@3" pin="1"/>
<junction x="146.05" y="92.964"/>
<wire x1="146.05" y1="92.964" x2="146.05" y2="91.44" width="0.1524" layer="91"/>
</segment>
<segment>
...
<wire x1="93.98" y1="78.74" x2="134.62" y2="78.74" width="0.1524" layer="91"/>
...
<wire x1="132.08" y1="48.26" x2="132.08" y2="83.82" width="0.1524" layer="91"/>
</segment>
</net>
<net name="I2C_SCL" class="0">
<segment>
...
<wire x1="88.9" y1="53.34" x2="129.54" y2="53.34" width="0.1524" layer="91"/>
...
<sheet>
<description>&lt;h1&gt;I²C-Bus&lt;/h1&gt;
Zur Kommunikation zwischen RaspberryPi und den angeschlossenen Verbrauchern dient der Philips entwickelte I²C-Bus, der ähnlich wie der SPI-Bus zur Kommunikation zwischen IC auf und zwischen Leiterplatten dient (&lt;strong&gt;I²C=Inter-Integrated-Circuits&lt;/strong&gt;). Aus diesem Design folgen ein paar ernsthafte Limitierungen:&lt;ul&gt;
&lt;li&gt;
Der I²C-Bus ist &lt;strong&gt;nicht differentiell&lt;/strong&gt;, d.h. es wird &lt;strong&gt;nicht&lt;/strong&gt; wie etwa bei CAN- oder RS485 mit zwei Datenpotentialen (D+, D-) gearbeitet, deren Differenzspannung vom Empfänger gebildet wird.&lt;/li&gt;
&lt;li&gt;I²C ist somit anfällig für Gleichtaktstörungen (z.B. Zündfunken), hat aufgrund der niedrigen (LV)TTL-Pegel eine begrenzte Reichweite und benötigt ähnlich wie die RS232 immer eine gemeinsame Masse als Bezugspotential.&lt;/li&gt;
&lt;li&gt;I²C ist ein &lt;strong&gt;getakteter Bus&lt;/strong&gt;&lt;/li&gt;
&lt;li&gt;I²C ist ein &lt;strong&gt;Master-Slave-Bussystem&lt;/strong&gt;&lt;/li&gt;
&lt;li&gt;Anzahl Teilnehmer ist auf 127 begrenzt&lt;/li&gt;
&lt;li&gt;Datenbreite für Register ist im Durchschnitt bei 16-Bit (implementierungabhängig)&lt;/li&gt;
&lt;li&gt;Terminierung erforderlich&lt;/li&gt;
&lt;li&gt;Datenraten von bis zu 5Mbit/s möglich&lt;/li&gt;
&lt;li&gt;serieller Bus (MSB-first Übertragung)&lt;/li&gt;
&lt;/ul&gt;
&lt;p&gt;
Diese Master-Slave-Busarchitektur ermöglicht es dem Master, zyklisch Werte vom Bus abzufragen (&lt;strong&gt;Polling&lt;/strong&gt;). Manche IC-Implementierungen ermöglichen zusätzlich die Verwendung von externen Interrupt-Pins, welche OnChange-Ereignisse signalisieren können. Aufgrund der dadurch resultierenden Verdrahtungskomplexität bietet sich das allerdings nur in speziellen Anwendungsfällen an, wo z.B. ein preiswerter und leistungsbegrenzter 8-Bit-Mikrocontroller (möglicherweise mit Optimierung auf maximale Batterielaufzeit) aufgrund eigener Resourcenrestriktionen und anderen integrierten Funktionen nicht ständig auf den I²C-Bus pollen kann.&lt;p&gt;
Aus der Perspektive des RaspberryPi als I²C-Master bietet sich I²C sehr an, da mit den &lt;b&gt;i2c-tools&lt;/b&gt; und den Linux-Kernel-Modul &lt;b&gt;i2c-bcm2708&lt;/b&gt; eine sehr leistungsstarke und komfortable Schnittstelle zur Arbeit mit I²C bereit steht. Die sehr gute Linux-Unterstützung für I²C rührt u.a. historisch auch daher, dass viele Temperatur-Sensoren auf PC-Mainboards über dieses Protokoll adressiert wurden (Stichwort &lt;b&gt;lm-sensors&lt;/b&gt;).
&lt;p&gt;
Die I²C-Slaves als Teilnehmer müssen mit &lt;b&gt;eindeutigen Adressen&lt;/b&gt; kodiert sein. Zu diesem Zweck dienen beim MCP23017 die Pins A[0..2], wodurch sich 2³=8 Teilnehmer unterscheiden lassen. Die Slave-Adressierung wird durch den montierten DIP-Schalter durchgeführt.</description>
<plain>
<text x="12.7" y="60.96" size="1.778" layer="91" rot="R90">I²C-Busabschluss</text>
<text x="132.08" y="96.52" size="1.778" layer="91">I²C-Slaveadressierung</text>
</plain>
<instances>
<instance part="FRAME4" gate="G$1" x="0" y="0"/>
<instance part="R3" gate="G$1" x="81.28" y="71.12" rot="R90"/>
<instance part="R4" gate="G$1" x="91.44" y="71.12" rot="R90"/>
<instance part="R5" gate="G$1" x="101.6" y="71.12" rot="R90"/>
<instance part="R6" gate="G$1" x="20.32" y="68.58" rot="R90"/>
<instance part="R7" gate="G$1" x="30.48" y="68.58" rot="R90"/>
<instance part="S1" gate="-1" x="121.92" y="81.28" rot="R90"/>
<instance part="S1" gate="-2" x="121.92" y="86.36" rot="R90"/>
<instance part="S1" gate="-3" x="121.92" y="91.44" rot="R90"/>
</instances>
<busses>
<bus name="+3.3V,GND">
<segment>
<wire x1="15.24" y1="55.88" x2="157.48" y2="55.88" width="0.762" layer="92"/>
<label x="73.66" y="50.8" size="1.778" layer="95"/>
</segment>
</bus>
<bus name="A[0..2]">
<segment>
<wire x1="73.66" y1="101.6" x2="157.48" y2="101.6" width="0.762" layer="92"/>
<label x="73.66" y="104.14" size="1.778" layer="95"/>
</segment>
</bus>
<bus name="I2C_SCL,I2C_SDA">
<segment>
<wire x1="15.24" y1="83.82" x2="35.56" y2="83.82" width="0.762" layer="92"/>
...
<wire x1="83.82" y1="55.88" x2="81.28" y2="58.42" width="0.1524" layer="91"/>
...
<wire x1="93.98" y1="55.88" x2="91.44" y2="58.42" width="0.1524" layer="91"/>
...
<wire x1="27.94" y1="55.88" x2="30.48" y2="58.42" width="0.1524" layer="91"/>
...
<wire x1="81.28" y1="81.28" x2="91.44" y2="91.44" width="0.1524" layer="91"/>
...
<wire x1="91.44" y1="78.74" x2="99.06" y2="86.36" width="0.1524" layer="91"/>
...
&lt;p&gt;
Eine wichtige Rolle für die Versorgungsspannung spielt der I²C-Bus, der zur Kommunikation zwischen dem RaspberryPi und den Busteilnehmern dient. I²C funktioniert im Gegensatz zu CAN-Bus oder anderen Feldbussystemen wie RS-485 &lt;strong&gt;nicht differenziell&lt;/strong&gt;. Das bedeutet in der Konsequenz, dass sowohl &lt;strong&gt;eine gemeinsame Masse&lt;/strong&gt;, als auch &lt;strong&gt;ein gemeinsames Bezugspotential&lt;/strong&gt; notwendig ist.&lt;p&gt;
Der Broadcom-ARM-Prozessor des RaspberryPi verwendet sowohl für GPIOs, als auch für SPI und I²C-Bus ein LVTTL-Pegel, d.h. +3.3V, welche sowohl für den I²C-Takt, als auch für die I²C-Datenleitung gelten.&lt;p&gt;
...
&lt;p&gt;
Für diese Zwecke wird ein Low-Drop-Spannungsregler von Texas Instruments vom Typ &lt;a href="http://www.ti.com/lit/ds/symlink/lm1117.pdf"&gt;LM1117&lt;/a&gt; eingesetzt.</description>
<plain>
</plain>
<instances>
<instance part="FRAME6" gate="G$1" x="0" y="0"/>
<instance part="IC2" gate="G$1" x="50.8" y="81.28" smashed="yes">
<attribute name="VALUE" x="58.42" y="86.36" size="1.778" layer="96" rot="R180"/>
</instance>
<instance part="X1" gate="-1" x="106.68" y="73.66" smashed="yes">
<attribute name="NAME" x="102.87" y="74.549" size="1.778" layer="95" rot="R180"/>
</instance>
<instance part="X1" gate="-2" x="106.68" y="68.58" smashed="yes">
<attribute name="NAME" x="102.87" y="69.469" size="1.778" layer="95" rot="R180"/>
<attribute name="VALUE" x="100.33" y="62.357" size="1.778" layer="96"/>
</instance>
<instance part="GND1" gate="1" x="114.3" y="60.96"/>
<instance part="P+1" gate="1" x="114.3" y="81.28"/>
<instance part="C1" gate="G$1" x="137.16" y="73.66"/>
<instance part="D1" gate="G$1" x="160.02" y="71.12" smashed="yes" rot="R90">
<attribute name="NAME" x="156.9974" y="68.58" size="1.778" layer="95" rot="R90"/>
<attribute name="VALUE" x="164.8714" y="63.5" size="1.778" layer="96" rot="R90"/>
</instance>
...
<instance part="GND3" gate="1" x="160.02" y="60.96"/>
...
<bus name="+12V,+5V,+3.3V,GND">
<segment>
<wire x1="27.94" y1="58.42" x2="73.66" y2="58.42" width="0.762" layer="92"/>
<wire x1="73.66" y1="58.42" x2="81.28" y2="66.04" width="0.762" layer="92"/>
<wire x1="81.28" y1="66.04" x2="81.28" y2="81.28" width="0.762" layer="92"/>
<wire x1="81.28" y1="81.28" x2="73.66" y2="88.9" width="0.762" layer="92"/>
<wire x1="73.66" y1="88.9" x2="27.94" y2="88.9" width="0.762" layer="92"/>
<wire x1="27.94" y1="88.9" x2="20.32" y2="81.28" width="0.762" layer="92"/>
<wire x1="20.32" y1="81.28" x2="20.32" y2="66.04" width="0.762" layer="92"/>
<wire x1="20.32" y1="66.04" x2="27.94" y2="58.42" width="0.762" layer="92"/>
</segment>
</bus>
</busses>
<nets>
